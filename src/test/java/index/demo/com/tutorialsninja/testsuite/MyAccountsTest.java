...
public class MyAccountsTest extends BaseTest {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        registerPage.sendFirstName("Hero");
        //3.4 Enter Last Name
        registerPage.sendLastName("Patel");
        //3.5 Enter Email
        registerPage.sendEmail("patel");
        //3.6 Enter Telephone
        registerPage.sendTelephone("07651234567");
        //3.7 Enter Password
        registerPage.sendPassword("Hell123456");
        //3.8 Enter Password Confirm
        registerPage.sendConfirmPassword("Hell123456");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        //enter password
        loginPage.sendPassword("Hell123456");
        //click login
